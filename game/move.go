...
func (s *GameState) ValidMoves(pos Position) {
	validMoves := []
...
func (m *BoundMove) Translate(pos Position, s GameState) {
...
func (m *UnboundMove) Translate(pos Position, s GameState) {
    newPos := new Position(pos.rank + m.rankOffset, pos.file + m.fileOffset)
    if s.PieceAtPosition(newPos) == nil {
...
func (m *AdvancingMoveMove) Translate(pos Position, s GameState) {
...
func (m *CapturingMove) Translate(pos Position, s GameState) {
    newPos := new Position(pos.rank + m.rankOffset, pos.file + m.fileOffset)
...
func (m *EnPassantMove) Translate(pos Position, s GameState) {
    newPos := new Position(pos.rank + m.rankOffset, pos.file + m.fileOffset)
...
func (m *CastlingMove) Translate(pos Position, s GameState) {
    //TODO
	return
}
